...
class LifestyledietCard extends StatefulWidget {
  final String title;
  final String value;
  ...
  @override
  State<LifestyledietCard> createState() => _LifestyledietCardState();
}

class _LifestyledietCardState extends State<LifestyledietCard> {
      ...
      child: Column(
        ...
        children: [
          ...
          LinearProgressIndicator(
            ...
            color: widget.statusColor,
            backgroundColor: AppColors.percentagebackground,
          ),
          if (_isExpanded) ...[
