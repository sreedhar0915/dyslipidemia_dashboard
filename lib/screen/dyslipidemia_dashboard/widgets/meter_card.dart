...
class MeterContainer extends StatefulWidget {
  final String title;
  final String rating;
  final String status;
  ...
  @override
  State<MeterContainer> createState() => _MeterContainerState();
}

class _MeterContainerState extends State<MeterContainer> {
